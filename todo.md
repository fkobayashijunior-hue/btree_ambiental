...
- [x] Tela de gerenciamento de fornecedores de combustível (CRUD + ativar/desativar)
...
- [x] Corrigir formulário de fornecedores na Hostinger (deploy desatualizado, formulário simplificado)
- [x] SQL seguro com IF NOT EXISTS para produção
...
- [x] Backend: procedure para enviar foto de NF/boleto e extrair dados via IA (LLM vision)
- [x] Frontend: botão "Ler NF por Foto" no formulário de Contas a Pagar
- [x] Upload de foto → S3 → LLM extrai dados → preenche formulário automaticamente
- [x] Usuário confere dados extraídos e salva

## 📄 RELATÓRIOS PDF - CONTAS A PAGAR (11/05/2026)

- [x] Relatório PDF de contas a pagar por período/fornecedor/status
...
- [x] Backend: mutation updateBoletoPaymentDate (recebe boletoId + nova data)
- [x] Frontend: botão de editar data de pagamento no card do boleto (ícone lápis ao lado de "Pago em: DD/MM/AAAA")
- [x] Frontend: dialog com campo de data para corrigir a data de pagamento
- [x] Compilar e push para GitHub
