...
## 🐛 BUGS E MELHORIAS REPORTADOS (29/03/2026 - noite)

### PDFs - Padronização visual (padrão Ficha do Colaborador)
- [ ] PDF de manutenção: cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link btreeambiental.com e QR code
- [ ] PDF de presença semanal: cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link e QR code
- [ ] PDF de carga: cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link e QR code

### Portal do Cliente - Bugs
- [ ] Erro 500 no portal: query replanting_records falhando (colunas faltando na Hostinger)
- [ ] Logo Kobayashi não aparece no rodapé do portal (imagem quebrada)
- [ ] Cargas não aparecem no portal após novo cadastro com clientId selecionado

### Controle de Cargas - Bugs
- [ ] Erro ao cadastrar destino no novo formulário de cargas
- [ ] Cargas cadastradas com novo formulário não aparecem no portal do cliente

### Assets
- [ ] Exportar logo BTREE do site para o usuário salvar localmente

## ✅ CORREÇÕES 29/03/2026 (Sessão noite)

### PDFs - Padronização visual
- [x] PDF de manutenção (EquipmentDetail): cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link btreeambiental.com e QR code
- [x] PDF de manutenção (MachineHoursPage): cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link e QR code
- [x] PDF de presença semanal (AttendanceList): cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link e QR code
- [x] PDF de presença diária (AttendanceList): cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link e QR code
- [x] PDF de carga (CargoControl): cabeçalho verde com logo BTREE + rodapé com logo Kobayashi, link e QR code
- [x] PDF de peças (PartsPage): URL da logo Kobayashi corrigida para CloudFront

### Portal do Cliente - Correções
- [x] Logo Kobayashi corrigida no portal do cliente (removido filtro brightness-0 invert, adicionado fundo branco)
- [x] SQL completo gerado para Hostinger incluindo tabelas faltantes (cargo_destinations, client_payments, replanting_records com colunas corretas)

### SQL para Hostinger
- [x] SQL_HOSTINGER_COMPLETO_29032026.sql gerado com todas as tabelas e colunas faltantes
